    ...
    <div class="lg:mr-64 xl:mr-72 p-4 sm:p-6 md:p-10 lg:p-12">
      ...
      <div v-else class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        <div
          ...
          class="app-card group bg-white rounded-2xl p-5 sm:p-6 transition-all duration-500 ease-out hover:shadow-2xl hover:shadow-gray-900/10 hover:-translate-y-1 active:scale-[0.98] cursor-pointer flex flex-col animate-fadeIn overflow-hidden relative"
        >
          ...
          <div class="relative z-10 flex flex-col h-full">
            ...
            <div class="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-5">
              ...
              <div v-if="appInstanceCounts[app.id] > 1" class="flex-shrink-0 flex items-center justify-center w-7 h-7 rounded-full bg-gradient-to-br from-blue-100 to-blue-50">
